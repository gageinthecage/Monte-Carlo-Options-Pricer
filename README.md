...
Three functions built to be implemented into the Monte Carlo Options Pricer. 
...
Another function combines the two and runs a number of simulated runs, putting each payoff into an empty list, averaging out the payoff and giving you the final average payoff from this call option.
